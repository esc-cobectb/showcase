...
$sModuleName = "openurbantech.mapmyride";
...
$aTabs = array(
	array(
		...
		"OPTIONS" => Array(
			"app_name" => Array(GetMessage("OUT_MAPMYRIDE_APP_NAME"), Array("text", 45)),
			"client_id" => Array(GetMessage("OUT_MAPMYRIDE_CLIENT_ID"), Array("text", 34)),
			"client_secret" => Array(GetMessage("OUT_MAPMYRIDE_CLIENT_SECRET"), Array("text", 45)),
			"client_token" => Array(GetMessage("OUT_MAPMYRIDE_CLIENT_TOKEN"), Array("text", 40)),
			"refresh_token" => Array(GetMessage("OUT_MAPMYRIDE_REFRESH_TOKEN"), Array("text", 40)),
			"hub.challenge" => Array(GetMessage("OUT_MAPMYRIDE_HUB_CHALLENGE"), Array("text", 40)),
		)
	),
);
